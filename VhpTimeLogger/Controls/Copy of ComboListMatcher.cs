...
//{
//    public class ComboListMatcherOud : ComboBox, IMessageFilter
//    {
...
//                popup = new PopupWindow(listBoxChild);
//                popup.Show(PutItHere);
//            }
//            else
//            {
//                HideTheList();
...
//                            listBoxChild.SelectedIndex = BepaalWaarde(NewIx, 0, listBoxChild.Items.Count - 1);
//                            return true;
...
//            return false;
//        }
//        private int BepaalWaarde(int index, int def, int maxIndex)
//        {
//            if (index > maxIndex)
//            {
//                return def;
